package com.jhipster.demo.dummy.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("dummy");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("dummy");
        ...
        config.getMapConfigs().put("com.jhipster.demo.dummy.domain.*", initializeDomainMapConfig(jHipsterProperties));
